...
package cn.embed.media.surfaceEncoder.gles;
...
public class FullFrameRect {
    ...
    /**
     * 矩阵平移，沿x,y 移动的距离，如向右移动0.1 ,则x传入的值为0.1,如果传入-0.1,怎是向左移动的距离
     *
     * @param x
     * @param y
     */
    ...
    public void scaleM(float x, float y) {
        Matrix.scaleM(IDENTITY_MATRIX, 0, x, y, 1f);
    }
    ...
    public void setMatrix(float[] texMatrix) {
        for (int i = 0; i < texMatrix.length; i++) {
            IDENTITY_MATRIX[i] = texMatrix[i];
        }
