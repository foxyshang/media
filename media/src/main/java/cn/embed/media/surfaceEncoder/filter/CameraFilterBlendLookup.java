...
public class CameraFilterBlendLookup extends CameraFilterBlend {

    public CameraFilterBlendLookup(Context context, Bitmap drawable) {
    ...
    protected int createProgram(Context applicationContext) {
        ...
        return GlUtil.createProgram(applicationContext, R.raw.vertex_shader_two_input,
                R.raw.fragment_shader_ext_lookup);
    }
}